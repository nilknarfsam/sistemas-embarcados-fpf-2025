...
class UAReferenceTypeImpl extends base_node_impl_1.BaseNodeImpl {
    ...
    constructor(options) {
         ...
         */
        this.isSubtypeOf = (0, tool_isSubtypeOf_1.construct_isSubtypeOf)(UAReferenceTypeImpl);
        /** @deprecated - use `isSubtypeOf` instead*/
        this.isSupertypeOf = (0, tool_isSubtypeOf_1.construct_isSubtypeOf)(UAReferenceTypeImpl);
        /**
         * @private
         */
        this._slow_isSubtypeOf = (0, tool_isSubtypeOf_1.construct_slow_isSubtypeOf)(UAReferenceTypeImpl);
